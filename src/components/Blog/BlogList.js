            ...
            <div className="container-fluid d-flex justify-content-center">
                ...
                <div className="row">
                    ...
                    {Blog.map((item, index) =>{
                        ...
                        <Card sett={sett} id={item.id} imgsrc={item.cover_image.url} title={item.title} description={item.description} selected={props.selected} setselected={props.setselected}/>
                    </div>
                          )
                }
                )}
